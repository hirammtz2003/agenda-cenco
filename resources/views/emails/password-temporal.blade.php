...
<body style="margin: 0; padding: 20px; font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f4f4f4;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; margin: 0 auto; background: white; border-collapse: collapse;">
        <!-- HEADER con color sólido (no gradiente) -->
        <tr>
        ...
        <tr>
            <td style="padding: 30px; background: white;">
                ...
                <p>Se ha generado una contraseña temporal para su cuenta en la plataforma.</p>
                
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
                    <tr>
                        <td style="background: #f9f9f9; border: 2px dashed #8b0000; padding: 15px; text-align: center;">
                            <span style="font-size: 28px; font-weight: bold; letter-spacing: 5px; color: #333;">{{ $password }}</span>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td style="padding: 15px;">
                            ...
                            <ul style="margin: 10px 0 0; padding-left: 20px; color: #856404;">
                                ...
                                <li>Al iniciar sesión, forzosamente deberá cambiarla por una nueva.</li>
                                <li>Si no solicitó esta contraseña, contacte al administrador.</li>
                            </ul>
                        </td>
                    </tr>
                </table>
                
                <!-- BOTÓN (estilo inline para Outlook) -->
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
                    <tr>
                        <td align="center">
