...
class BecaController extends Controller
{
    ...
    private function verificarAcceso()
    {
        ...
        // Puede acceder si tiene G o C en posición 1 O G o C en posición 2
        $puedeAcceder = PrivilegiosHelper::consultaGeneral($user) || 
    ...
    public function index()
    {
        ...
        $puedeConsultar = PrivilegiosHelper::consultaGeneral($user) || 
                          PrivilegiosHelper::consultaGrado($user);
        
        return view('usuarios.becas.becas', compact('puedeEditar', 'puedeConsultar'));
    }
